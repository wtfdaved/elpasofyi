        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <motion.div variants={itemVariants}>
              <h3 className="text-2xl font-lora font-bold mb-2 text-slate-900">
            ...
            {/* Quick links */}
            <motion.div variants={itemVariants}>
              <h4 className="text-sm font-lora font-semibold uppercase tracking-wide text-terracotta mb-4">
                Explore
              </h4>
