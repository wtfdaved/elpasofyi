    ...
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 relative overflow-hidden bg-light-bg">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-fraunces font-bold mb-6 relative inline-block leading-tight text-slate-900">
        ...
        >
          Discover authentic El Paso. <span className="text-terracotta font-semibold">Events, restaurants, weekend itineraries, and local culture.</span>
        </motion.p>
        ...
        <motion.div variants={itemVariants} className="max-w-md mx-auto mb-12">
          <div className="flex items-center justify-center mb-4 text-terracotta">
            ...
            <span className="text-sm font-fraunces font-semibold tracking-wider">THE WEEKEND DROP</span>
          </div>
          <NewsletterForm />
